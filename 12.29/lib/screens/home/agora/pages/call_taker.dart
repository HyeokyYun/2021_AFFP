import 'dart:async';
import 'dart:ui';
import 'package:cap_007_auth_noti/screens/home/agora/utils/settings.dart';
    ...
    _engine.setEventHandler(RtcEngineEventHandler(
      ...
      streamMessage: (_, __, _coordinates) {
        ...
        if (_coordinates.compareTo('end') == 0) {
          FirebaseFirestore.instance.collection('videoCall').doc(firebaseUser!.uid).delete();
          Navigator.pop(context);
        } else {
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: const NetworkImage("https://i.ibb.co/nsVhXLq/black-background.jpg"),
          fit: BoxFit.cover,
